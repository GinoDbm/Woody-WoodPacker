...
$(STUB_OBJ): $(STUB_SRC) stub/stub.ld
	$(CC) -Wall -Wextra -Werror -ffreestanding -fno-pie -fno-asynchronous-unwind-tables -fno-stack-protector -fcf-protection=none -c $(STUB_SRC) -o stub/stub_freestanding.o
